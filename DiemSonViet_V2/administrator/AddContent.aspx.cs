...
public partial class administrator_AddContent : System.Web.UI.Page
{
    ...
    private string GetImg()
    {
        ...
        if (File.Exists(Server.MapPath("~/") + "uploads/icons/" + fUpiCon.FileName))
            FileName = DateTime.Now.Ticks.ToString() + "_" + fUpiCon.FileName;
        else
            FileName = fUpiCon.FileName;
        fUpiCon.SaveAs(Server.MapPath("~/") + "uploads/icons/" + FileName);
        return FileName;
    }
