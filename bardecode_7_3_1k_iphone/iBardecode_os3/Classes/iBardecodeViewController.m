...
@synthesize result, value, type, takePhoto, doScan, choosePhoto, readEAN13etc, readCode39etc, read2D;
...
-(IBAction) buttonPress:(id) sender {
	...
	if((UIButton *) sender == choosePhoto) {
		[barcode ScanBarcodeFromCameraRoll] ;
	} else if ((UIButton *) sender == takePhoto){
		[barcode ScanBarcodeFromCamera];
	} else {
